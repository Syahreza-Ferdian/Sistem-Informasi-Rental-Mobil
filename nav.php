...
<head>
    ...
    <title><?=$pageTitle ?? 'Index'?> | Toretto Rent Car</title>
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                ...
                <div class="offcanvas-body">
                    <div class="list-group list-group-flush">
                        <a class="list-group-item list-group-item-action p-3" href="?page=index"><div class="row"><div class="col-2"><i class="fa-solid fa-house fa-xl"></i></div><div class="col"><span>Home</span></div></div></a>
                        <a class="list-group-item list-group-item-action p-3" href="?page=daftar_mobil"><div class="row"><div class="col-2"><i class="fa-solid fa-car-side fa-xl"></i></div><div class="col"><span>Daftar Mobil</span></div></div></a>
